...
def main():
    ...
    parser.add_argument('-train_tgt', default='./data/multi30k/train.de' )
    parser.add_argument('-valid_src', default='./data/multi30k/val.en' )
    parser.add_argument('-valid_tgt', default='./data/multi30k/val.de' )
    parser.add_argument('-save_data', default='./data/multi30k' )
